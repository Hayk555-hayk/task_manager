...
const notes = {
    ...
    'Programming Books': [
        'PHP Objects, Patterns, and Practice" by Matt Zandstra глава 2 (по 1-й главе)',
    ],
    'Coursera': [
        'Web Application development, basic concept (по 2 видео)',
    ],
    'Ruby': [
        'www.ruby-lang.org урок 1 (по 1 урок)',
    ...
    'Ruby on Rails': [
        'guides.rubyonrails.org урок 1 (по 1 урок)',
    ...
    'PHP': [
        'Уроки PHP на code.mu основной учебник - урок 5 (по 1 урок)',
    ...
    'Laravel': [
        'Уроки Laravel на laravel.su урок НАЧАЛО РАБОТЫ -> Структура каталогов (по 1 урок)',
    ...
    'Node JS': [
        'Уроки Node js на metanit.com урок 1 (по 1 урок)'
    ],
    'Nest JS': [
        'Уроки по Nest JS на nestjs.ru урок 1 (по 1 урок)'
    ],
    'JavaScript': [
        'Уроки JavaScript на metanit.com урок 1 (по 1 урок)'
    ],
    'React JS': [
        'Уроки React js на metanit.com урок 1 (по 1 урок)'
    ],
    'Vue JS': [
        'Уроки на metanit, урок 1 (по 1 урок)'
    ],
    'Angular JS': [
        'Уроки на metanit, урок 1 (по 1 урок)'
    ],
    'Add techno': [
        'Уроки Graphql  на https://tproger.ru/translations/graphql-beginners-guide/ урок 1 (по 1 урок)'
    ],
    'English': [
        'lingust урок 2 (по 1 урок)'
    ] ,
    'German': [
        'lingust урок 1 (по 1 урок)'
    ] ,
    'Spanish': [
        'lingust урок 2 (по 1 урок)',
    ...
    'Reading the Bible': ['Reading the Bible (стр 20 пункт 15) (по 2-е страници)'],
    'Writing a letter': ['Writing a letter'],
    'Reading the Bible through an app': ['Reading the Bible through an app (по 1-й главе)'],
    'Algebra': [
        'Уроки по метематике 5 класс DaVinch YouTube урок 11 (по 1 урок)',
    ...
    'Geometry': [
        'Сначало нужно завершить математику 5, 6 классы (по 1 урок)'
    ],
    'Physics': [
        'Сначало нужно завершить математику 5, 6 классы (по 1 урок)'
    ],
    'Sport': [
        "Жим лежа и приседания по 10",
        "Грудь резина разводка стоя 30",
        "Жим на грудь удержание 1 минута", 
        "Пресс планка удержание 1 минута",
        "Жим колени на полу с вытягиванием руки вперёд 20",
        "Подтягивание стопы к руке на планке 10",
        "Лежа на животе проработка спины 20", 
        "Жим на руки и пресс скалолаз по 10",
        "Пресс обычный 30",
        "Бицепс резина по 40",
        "Жим стена бицепс по 30",
        "Приседания с широкой постановкой ног 15",
        "Ноги ягоды с касанием руки к полу 10",
        "Боковые выпады с касанием пола 15",
        "Жим наоборот 15",
        "Пресс скалолаз 25",
        "Плечи резина разводка стоя 30",
        "Жим стена плечи по 30",
        "Пресс ног 30",
        "Планка в движении 10",
        "Планка с прокручиванием и поднятием руки на право и на лево 10",
        "Пресс кросс локти к коленям 20"
    ],
    'YouTube Practice': [
        'Alex Merced: react + ruby on rails build урок 1 (по 1 урок)',
