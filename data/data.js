...
let tasks = [
    ...
    YouTube DarkProger Новейший курс по php (урок 4) 
    </span><br />
    <span class="small">
    ...
    <span class="task_description">
    YouTube The net ninja all vue tutorials
    </span> <br />
    <span class="small">
    YouTube bitfumes nuxt js, YouTube JavaScript ru git, Documentation Metanit
    </span>`,
